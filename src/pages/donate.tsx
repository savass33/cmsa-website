      ...
      <FadeIn>
        <div className="relative w-full h-50">
          ...
          <div className="relative h-full flex items-center justify-center">
            <h1 className="font-heading text-center px-6 text-5xl text-white md:text-7xl transition-all duration-300 ease-in-out hover:opacity-80">
              Benfeitoria
            </h1>
          </div>
        </div>
        ...
        <FadeIn delay={400} className="flex flex-col gap-6">
          <div className="bg-white p-8 md:p-10 rounded-3xl shadow-lg border border-neutral-100 flex flex-col items-center text-center">
            ...
            <div className="w-full border-t border-neutral-100 pt-8 mt-4 flex flex-col items-center gap-4">
              ...
              <a href="https://wa.me/55859986972081" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 text-neutral-700 hover:text-primary-600 transition-colors">
